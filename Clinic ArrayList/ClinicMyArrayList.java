...
import ru.lesson.lessons.MyArrayList;

/**
 * Created by trit on 03.03.2016.
 */
public class ClinicMyArrayList {
    ...
    private final MyArrayList<Client> clients;
    ...
    public ClinicMyArrayList(){
        clients = new MyArrayList<Client>();
